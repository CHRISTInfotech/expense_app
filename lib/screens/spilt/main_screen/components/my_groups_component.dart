...
import '../..//main_screen/components/my_groups_component_list_skeleton.dart';
import '../..//main_screen/handlers/group_handler.dart';
import '../..//group_screen/my_created_group_detail_screen.dart';
import '../..//main_screen/view_my_all_groups_screen.dart';
...
class _MyGroupsComponentState extends ConsumerState<MyGroupsComponent> {
  ...
  _getMyGroups() async {
    try {
      List<MyGroupModel>? res = (await getMyGroups())!.cast<MyGroupModel>();
      if (res != null) {
