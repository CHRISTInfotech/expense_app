...
import '../../group_to_pay_detail_screen/group_to_pay_detail_screen.dart';
import '../../main_screen/components/groups_to_pay_skeleton_list.dart';
import '../..//main_screen/handlers/group_handler.dart';
import '../..//main_screen/view_all_groups_screen.dart';
import '../../../../config/colors.dart';
import '../../../../providers/groups_to_pay_provider.dart';
...
class _GroupsToPayComponentState extends ConsumerState<GroupsToPayComponent> {
  ...
  _getGroupsToPay() async {
    ...
    try {
      List<MyGroupModel>? groupsToPay = (await getGroupsToPay())!.cast<MyGroupModel>();
      if (groupsToPay != null) {
