...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(key: widget.scaffoldKey,
      resizeToAvoidBottomInset: false,
      backgroundColor: Colors.white,

      appBar: AppBar(
        centerTitle: true,
        title: new Text("Account Settings", style: TextStyle(color: kDarkSecondary)),
        backgroundColor: Colors.white,
        elevation: 0.0,
          ...
          onTap: () async { 
            ...
            Widget deleteButton = TextButton(
              ...
              onPressed: () async { 
                ...
                dynamic result = await _auth.deleteUser(globals.userData.email!, password);
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: <Widget>[
                      Text("Your account information will be permanently removed and it cannot not be recovered.", textAlign: TextAlign.start,),
