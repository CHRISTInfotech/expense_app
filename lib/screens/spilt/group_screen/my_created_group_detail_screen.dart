...
import '..//group_screen/components/bill_list_item.dart';
import '../group_screen/create_bill_screen.dart';
import '../group_screen/handlers/bill_handler.dart';
import '../group_screen/mybill_detail_screen.dart';
import '../group_to_pay_detail_screen/group_total_expense_screen.dart';
  ...
  _getGroupBills() async {
    ...
    try {
      List<CurrentGroupBillModel>? bills =
          (await getBills(groupId: widget.docid))!.cast<CurrentGroupBillModel>();
