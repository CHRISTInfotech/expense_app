...
Widget header(){
  return Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text("Hi,", style: TextStyle( fontSize: 28), textAlign: TextAlign.left,),
        Text(globals.userData.fullName!, style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 28),),
        SizedBox(height: 40,),
      ],
    ),
  );
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              ...
              Text( '\$${globals.monthIncome.toStringAsFixed(1)}',
                style: TextStyle(
              ...
              Text( '\$${globals.monthExpense.toStringAsFixed(1)}',
                style: TextStyle(
                  color: Colors.blueGrey[300],
                ),
              ),
